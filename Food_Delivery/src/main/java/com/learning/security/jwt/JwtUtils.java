...
public class JwtUtils {
	...
	//when credentials are matched then only will come to this class
		...
		{//username
			...
			.setExpiration(new Date(new Date().getTime()+jwtExpiryValue)).signWith(SignatureAlgorithm.HS512, jwtSecret).compact();
